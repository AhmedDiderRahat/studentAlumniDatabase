...
public class search_result extends javax.swing.JFrame 
{
    ...
    public search_result(String ip) throws SQLException 
    {
        keys = ip;
        initComponents();
    ...
    public ArrayList arr() throws SQLException 
    {
        ...
        try 
        {
            ...
            String s1, s2, s3, s4, id, name, f_name, m_name, dept, batch, dob, mobile_no, e_mail, bg, religion, pass_year, convocation_year;
 ...
 //           x2 = rs.getString("add_type");
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Search Result For: " + keys);
        ...
        logout.setForeground(new java.awt.Color(51, 0, 153));
...
//                try 
//                {
//                    search_result ob = new search_result("130203020005");
//                } catch (SQLException ex) {
