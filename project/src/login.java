...
public class login extends javax.swing.JFrame 
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DbConnect obd = new DbConnect();       
        
        boolean bl = false;
        try 
        {
            bl = obd.getData(s1, s2);
        ...
        if(bl)
        {
            home_in ob1 = new home_in();
     
            this.dispose();
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Worng username or pasword...!!!", "Warning" ,JOptionPane.ERROR_MESSAGE);
            login obl = new login();
            this.dispose();
        }        
